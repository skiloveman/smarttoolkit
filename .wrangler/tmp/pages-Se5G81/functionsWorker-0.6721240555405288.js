...
// api/contact.ts
var DEFAULT_TARGET_EMAIL = "skiloveman@naver.com";
function toSafeText(value, max = 4e3) {
...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  try {
    ...
    const details = toSafeText(body.details, 3e3);
    ...
    if (!sendResult.ok) {
      ...
      return Response.json(
        { ok: false, message: `\uBA54\uC77C \uC804\uC1A1 \uC2E4\uD328: ${failText || sendResult.statusText}` },
        { status: 502 }
      );
    }
...
// ../.wrangler/tmp/pages-Se5G81/functionsRoutes-0.25476457369669314.mjs
var routes = [
  {
