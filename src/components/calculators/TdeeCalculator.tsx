      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex justify-between text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
            <span>나이</span>
            <span className="font-bold text-amber-600 dark:text-amber-400">{age}세</span>
          </div>
          <input type="range" min="10" max="100" value={age} onChange={(e) => setAge(Number(e.target.value))} className="w-full accent-amber-500 cursor-pointer" />
        </div>

        <div>
          <div className="flex justify-between text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
            <span>신장 (키)</span>
            <span className="font-bold text-amber-600 dark:text-amber-400">{heightCm} cm</span>
          </div>
          <input type="range" min="100" max="230" value={heightCm} onChange={(e) => setHeightCm(Number(e.target.value))} className="w-full accent-amber-500 cursor-pointer" />
        ...
        <div>
          <div className="flex justify-between text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">
            <span>체중 (몸무게)</span>
            <span className="font-bold text-amber-600 dark:text-amber-400">{weightKg} kg</span>
          </div>
          <input type="range" min="20" max="250" value={weightKg} onChange={(e) => setWeightKg(Number(e.target.value))} className="w-full accent-amber-500 cursor-pointer" />
          <div className="mt-2 flex justify-between gap-2">
